...
Cilium test suite is based on Ginkgo test framework, before start writing test,
maybe it is a good idea to read Ginkgo Quickstart guide and run this test suite
example written by the Ginkgo creator.
...
ubuntu 17.04 server with all cilium dependencies already in place.
...
- Kubernetes e2e is using Ginkgo
- Openshift is using Ginkgo, and they presented it.
