...
func (in *CiliumChildPolicyStatus) DeepCopyInto(out *CiliumChildPolicyStatus) {
	*out = *in
	in.LastUpdated.DeepCopyInto(&out.LastUpdated)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumChildPolicyStatus.
func (in *CiliumChildPolicyStatus) DeepCopy() *CiliumChildPolicyStatus {
	if in == nil {
		return nil
	}
	out := new(CiliumChildPolicyStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CiliumNetworkPolicyStatus) DeepCopyInto(out *CiliumNetworkPolicyStatus) {
	*out = *in
	...
	if in.ChildrenPolicies != nil {
		in, out := &in.ChildrenPolicies, &out.ChildrenPolicies
		*out = make(map[string]CiliumChildPolicyStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
