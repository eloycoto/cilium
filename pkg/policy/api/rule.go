...
// HasChildRule it return true if the rule has a child rule.
func (r *Rule) HasChildRule() bool {
...
// CreateChildRule will return a new Rule with the new data based gather
// by the rules that autogenerated new Rule
func (r *Rule) CreateChildRule() (*Rule, error) {
	newRule := r.DeepCopy()
	newRule.Egress = []EgressRule{}
	newRule.Ingress = []IngressRule{}

	for _, egressRule := range r.Egress {
		childEgressRule, err := egressRule.CreateChildRule()
		if err != nil {
			return newRule, err
		}
