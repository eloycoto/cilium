...
// HasChildRule returns true if the policy has any rule that will create
// a new child policy in the future.
func (e *EgressRule) HasChildRule() bool {
	if len(e.ToGroups) > 0 {
		return true
	}
	return false
...
// CreateChildRule will return a new rule based on the data gathered by
// the rules that creates a new child policy.
func (e *EgressRule) CreateChildRule() (*EgressRule, error) {
